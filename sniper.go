...
loop:
	...
	default:
		...
		if len(s.deferSendQueue)+len(b) > s.cachsize {
			...
			// here i want defer fun wrap , let deferSendQueue as much as possible
			// make a rand , has 60% chance defer wrap
